...
class Izvodjenje(MuzickiElement):
    def __init__(self, naziv: str, slika: str, pregledi: int, broj_ocena: int, zbir_ocena: int, mesto: str, vreme: str, link: str, vrsta_izvodjenja: VrstaIzvodjenja, muzicka_dela : list):
